...
def _make_system_prompt(cot=False, has_cutout=False):
    ...
    base = (
        ...
        "The shape gate overrides ALL color/WISE signals.\n\n"
        "- PLATEAU: > 50 d of flat/slow decline after peak \u2192 SN (IIP-like).\n"
        "  This is a STRUCTURAL feature, independent of rise morphology.\n"
        "  Classify as SN regardless of optical color.\n"
        ...
        "### Step 1: Color \u00d7 Shape Joint Matrix\n"
        "Apply rows TOP-TO-BOTTOM (first match wins).\n"
        "| Optical Color | W1-W2 | Shape | \u2192 Result |\n"
        "|:---|:---|:---|:---|\n"
        ...
        "| SN | \u2265 0.8 | any | **AGN** (weak) |\n"
        "| SN | [0.5,0.8) or N/A | convex | **SN** (strong) |\n"
        "| SN | [0.5,0.8) or N/A | concave | **Unsure\u2192SN** |\n"
        "| None | \u2265 0.8 | concave | **AGN** |\n"
        "| None | \u2265 0.8 | convex | **Others** |\n"
        "| None | < 0.5 | concave | **TDE** (weak) |\n"
        "| None | < 0.5 | convex | **SN** (weak) |\n"
        "| None | [0.5,0.8) or N/A | concave | **TDE?** (very weak) |\n"
        "| None | [0.5,0.8) or N/A | convex | **SN?** (very weak) |\n"
        "| None | [0.5,0.8) or N/A | unclear | **Unsure** |\n"
        ...
        "  When both agree on same class \u2192 score \u2265 0.85.\n"
    ...
    if cot:
            cot_section = (
                ...
                "Step 4 — Joint Matrix: apply Color × WISE × Shape matrix "
